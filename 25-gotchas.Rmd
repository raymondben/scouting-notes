...
- As of VBStats version 2.34.232, it is not possible to enter further actions (during the same point) after a serve ace or attack kills. But we want to know who made the reception or dig error, so we need to enter that action as well. There are three options, with the first being the preferred method:
