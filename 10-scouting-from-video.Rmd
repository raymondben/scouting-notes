...
- P1 = a negative pass or an overpass (DataVolley "R-" or "R/"), generally only allowing a high ball set to be made or even no proper attack at all (a freeball back to the opposition or an overpass)
