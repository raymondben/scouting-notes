...
- finding areas that could be improved on, areas that are working well (for individuals and teams as a whole)
- assess how game performance compares to training goals and team strategies
- assessing other teams to help prepare for upcoming matches
- providing feedback to players
- preparing match summaries and other information for media, team supporters, or stakeholders (e.g. sponsors)
