...
**Required:** the attacking player and the setting zone.

The setting zone, despite its name, tells us the type of attack. See the [Scouting from video](scouting-from-video.html) section for details on scouting attacks.

**Optional:** if you have time, also include (in order of importance):

- the number of blockers on the attack
- the ball path of the attack
